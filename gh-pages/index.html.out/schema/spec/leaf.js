...
schema.spec.leaf.LeafSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8437__auto__,k16149,else__8438__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k16149,else__8438__auto__);
...
schema.spec.leaf.LeafSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__16148){
var self__ = this;
var G__16148__$1 = this;
return (new cljs.core.RecordIter((0),G__16148__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pre], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
schema.spec.leaf.LeafSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8442__auto__,k__8443__auto__,G__16148){
var self__ = this;
var this__8442__auto____$1 = this;
var pred__16152 = cljs.core.keyword_identical_QMARK_;
var expr__16153 = k__8443__auto__;
if(cljs.core.truth_((function (){var G__16155 = cljs.core.cst$kw$pre;
var G__16156 = expr__16153;
return (pred__16152.cljs$core$IFn$_invoke$arity$2 ? pred__16152.cljs$core$IFn$_invoke$arity$2(G__16155,G__16156) : pred__16152.call(null,G__16155,G__16156));
})())){
return (new schema.spec.leaf.LeafSpec(G__16148,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.leaf.LeafSpec(self__.pre,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__8443__auto__,G__16148),null));
}
});
...
schema.spec.leaf.LeafSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8434__auto__,G__16148){
var self__ = this;
var this__8434__auto____$1 = this;
return (new schema.spec.leaf.LeafSpec(self__.pre,G__16148,self__.__extmap,self__.__hash));
});
...
schema.spec.leaf.map__GT_LeafSpec = (function schema$spec$leaf$map__GT_LeafSpec(G__16150){
return (new schema.spec.leaf.LeafSpec(cljs.core.cst$kw$pre.cljs$core$IFn$_invoke$arity$1(G__16150),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__16150,cljs.core.cst$kw$pre),null));
});
