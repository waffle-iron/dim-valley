...
var G__18622 = (((cljs.core.first(e) instanceof cljs.core.Keyword))?cljs.core.first(e).fqn:null);
switch (G__18622) {
case "schema.spec.collection/optional":
var G__18623 = cljs.core.next(e);
var G__18624 = params;
var G__18625 = then;
return (schema.spec.collection.sequence_transformer.cljs$core$IFn$_invoke$arity$3 ? schema.spec.collection.sequence_transformer.cljs$core$IFn$_invoke$arity$3(G__18623,G__18624,G__18625) : schema.spec.collection.sequence_transformer.call(null,G__18623,G__18624,G__18625));
...
return (function (res,x){
var G__18626 = res;
var G__18627 = (function (){var G__18628 = ((function (G__18626,parser,c){
return (function (t){
...
;
var G__18629 = x;
return (parser.cljs$core$IFn$_invoke$arity$2 ? parser.cljs$core$IFn$_invoke$arity$2(G__18628,G__18629) : parser.call(null,G__18628,G__18629));
})();
return (then.cljs$core$IFn$_invoke$arity$2 ? then.cljs$core$IFn$_invoke$arity$2(G__18626,G__18627) : then.call(null,G__18626,G__18627));
});
;})(parser,c))
}
});
schema.spec.collection.sequence_transformer = (function schema$spec$collection$sequence_transformer(elts,params,then){
if(cljs.core.not_any_QMARK_((function (p1__18631_SHARP_){
return (cljs.core.vector_QMARK_(p1__18631_SHARP_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(p1__18631_SHARP_),cljs.core.cst$kw$schema$spec$collection_SLASH_remaining));
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8437__auto__,k18633,else__8438__auto__){
var self__ = this;
var this__8437__auto____$1 = this;
var G__18635 = (((k18633 instanceof cljs.core.Keyword))?k18633.fqn:null);
switch (G__18635) {
case "pre":
return self__.pre;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k18633,else__8438__auto__);
...
var res = (function (){var G__18636 = cljs.core.PersistentVector.EMPTY;
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__18636) : cljs.core.atom.call(null,G__18636));
})();
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__18632){
var self__ = this;
var G__18632__$1 = this;
return (new cljs.core.RecordIter((0),G__18632__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pre,cljs.core.cst$kw$constructor,cljs.core.cst$kw$elements,cljs.core.cst$kw$on_DASH_error], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8442__auto__,k__8443__auto__,G__18632){
var self__ = this;
var this__8442__auto____$1 = this;
var pred__18637 = cljs.core.keyword_identical_QMARK_;
var expr__18638 = k__8443__auto__;
if(cljs.core.truth_((function (){var G__18640 = cljs.core.cst$kw$pre;
var G__18641 = expr__18638;
return (pred__18637.cljs$core$IFn$_invoke$arity$2 ? pred__18637.cljs$core$IFn$_invoke$arity$2(G__18640,G__18641) : pred__18637.call(null,G__18640,G__18641));
})())){
return (new schema.spec.collection.CollectionSpec(G__18632,self__.constructor$,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__18642 = cljs.core.cst$kw$constructor;
var G__18643 = expr__18638;
return (pred__18637.cljs$core$IFn$_invoke$arity$2 ? pred__18637.cljs$core$IFn$_invoke$arity$2(G__18642,G__18643) : pred__18637.call(null,G__18642,G__18643));
})())){
return (new schema.spec.collection.CollectionSpec(self__.pre,G__18632,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__18644 = cljs.core.cst$kw$elements;
var G__18645 = expr__18638;
return (pred__18637.cljs$core$IFn$_invoke$arity$2 ? pred__18637.cljs$core$IFn$_invoke$arity$2(G__18644,G__18645) : pred__18637.call(null,G__18644,G__18645));
})())){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,G__18632,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__18646 = cljs.core.cst$kw$on_DASH_error;
var G__18647 = expr__18638;
return (pred__18637.cljs$core$IFn$_invoke$arity$2 ? pred__18637.cljs$core$IFn$_invoke$arity$2(G__18646,G__18647) : pred__18637.call(null,G__18646,G__18647));
})())){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,G__18632,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__8443__auto__,G__18632),null));
}
}
}
}
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8434__auto__,G__18632){
var self__ = this;
var this__8434__auto____$1 = this;
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,G__18632,self__.__extmap,self__.__hash));
});
...
schema.spec.collection.map__GT_CollectionSpec = (function schema$spec$collection$map__GT_CollectionSpec(G__18634){
return (new schema.spec.collection.CollectionSpec(cljs.core.cst$kw$pre.cljs$core$IFn$_invoke$arity$1(G__18634),cljs.core.cst$kw$constructor.cljs$core$IFn$_invoke$arity$1(G__18634),cljs.core.cst$kw$elements.cljs$core$IFn$_invoke$arity$1(G__18634),cljs.core.cst$kw$on_DASH_error.cljs$core$IFn$_invoke$arity$1(G__18634),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__18634,cljs.core.cst$kw$pre,cljs.core.array_seq([cljs.core.cst$kw$constructor,cljs.core.cst$kw$elements,cljs.core.cst$kw$on_DASH_error], 0)),null));
});
...
var len__8981__auto___18650 = arguments.length;
var i__8982__auto___18651 = (0);
while(true){
if((i__8982__auto___18651 < len__8981__auto___18650)){
args__8988__auto__.push((arguments[i__8982__auto___18651]));

var G__18652 = (i__8982__auto___18651 + (1));
i__8982__auto___18651 = G__18652;
continue;
} else {
}
break;
...
schema.spec.collection.optional.cljs$lang$applyTo = (function (seq18649){
return schema.spec.collection.optional.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq18649));
});
